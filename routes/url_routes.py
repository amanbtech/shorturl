...
from schemas import Urls, UpdateUrl,forget, verify_otp,resetpassword
...
def reset(reset_data:resetpassword):
    cursor=get_cursor()
    hashed_password=bcrypt.hashpw(
        reset_data.password.encode(),bcrypt.gensalt()
    )
    cursor.execute("UPDATE users SET password_hash=? WHERE email=?,(hashed_password.decode(),reset_data.email)")
